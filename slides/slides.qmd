...
## Simulating a pseudoproxy archive
...
- represent a multi-driver environment that allows for driver interactions and synergies
...
::: {.column width="70%"}
![](./images/degradation_process_disturbed_for_export.png){width="80%"}
:::
::::
...
:::{.column width="60%"}
![](./images/miracle_occurs.png){height="50%"}
:::
::::

## Assessing uncertainties across replicates

**Quantify the difference between the 'error-free' archive and each level of uncertainty.** The following is an example from scenario 1
...
- George Perry and Janet Wilmshurs

- Jack Williams and Tony Ives

- Biological heritage and the National Science Foundation
